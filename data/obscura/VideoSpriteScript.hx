...
var cacheList:Array<String> = ['mariohh'];
...
function makeVideoSprite(tag:String, path:String, ?x:Float = 0.0, ?y:Float = 0.0, ?camera:String = "game", ?shouldLoop:Bool = false, ?scaleX:Float = 2.0, ?scaleY:Float = 2.0):Void
{
